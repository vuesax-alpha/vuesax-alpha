<template>
  <div class="center checks">
    ...
    <vs-checkbox v-model="option2" success>
      <template #icon>
        <i class="bx bx-check-double" />
      </template>
    </vs-checkbox>
    <vs-checkbox v-model="option3" danger>
      <template #icon>
        <i class="bx bx-x" />
      </template>
    </vs-checkbox>
    <vs-checkbox v-model="option4" warn>
      <template #icon>
        <i class="bx bxs-shield" />
      </template>
    </vs-checkbox>
    <vs-checkbox v-model="option5" dark>
      <template #icon>
        <i class="bx bxs-heart" />
      </template>
    </vs-checkbox>
    <vs-checkbox v-model="option6" color="#7d33ff">
      <template #icon>
        <i class="bx bx-brightness" />
      </template>
    </vs-checkbox>
    <vs-checkbox v-model="option7" color="rgb(59,222,200)">
      <template #icon>
