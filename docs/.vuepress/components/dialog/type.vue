<template>
  <div class="center">
    ...
    <vs-button border @click="active3 = !active3"> Prompt </vs-button>
    <vs-dialog v-model="active" width="550px" not-center>
      ...
      <template #footer>
        <div class="con-footer">
          <vs-button transparent @click="active = false"> Ok </vs-button>
        </div>
      </template>
    </vs-dialog>
    <vs-dialog v-model="active2" width="550px" not-center>
      ...
      <template #footer>
        <div class="con-footer">
          <vs-button transparent @click="active2 = false"> Ok </vs-button>
          <vs-button dark transparent @click="active2 = false">
            Cancel
          </vs-button>
        </div>
      </template>
    ...
    <vs-dialog v-model="active3" width="300px" not-center>
      ...
      <template #footer>
        <div class="con-footer">
          <vs-button transparent @click="active3 = false"> Ok </vs-button>
          <vs-button dark transparent @click="active3 = false">
            Cancel
          </vs-button>
        </div>
      </template>
