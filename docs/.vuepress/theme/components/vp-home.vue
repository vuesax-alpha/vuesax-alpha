...
import Illustration2 from './home-illustration-2.vue'
import Illustration3 from './home-illustration-3.vue'
import Illustration4 from './home-illustration-4.vue'
import HomeComponent from './home-component.vue'
import HomeTwitter from './home-twitter.vue'
import HomeUses from './home-uses.vue'
import type { ThemeProjectHomePageFrontmatter } from '../shared/frontmatter/home'
...
const numberWithCommas = computed(() => {
  const _star = star.value || 0
  const parts = _star.toString().split('.')
