...
- If you want to see all available SVG icons please check [@vuesax-alpha/icons-vue@1.x](https://unpkg.com/browse/@vuesax-alpha/icons-vue@1/dist/es/)[@vuesax-alpha/icons-vue@latest](https://unpkg.com/browse/@vuesax-alpha/icons-vue@latest/dist/types/components/) and the source [vuesax-alpha-icons](https://github.com/vuesax-alphax/vuesax-alpha-icons) out or [Icon Collection](#icon-collection)
...
You need import all icons from `@vuesax-alpha/icons-vue` and register them globally.

```ts
// main.ts

// if you're using CDN, please remove this line.
import * as ElementPlusIconsVue from '@vuesax-alpha/icons-vue'
...
```html
<script src="//unpkg.com/@vuesax-alpha/icons-vue"></script>
```

#### jsDelivr

```html
<script src="//cdn.jsdelivr.net/npm/@vuesax-alpha/icons-vue"></script>
```
...
You can refer to [this template](https://github.com/sxzz/vuesax-alpha-best-practices/blob/db2dfc983ccda5570033a0ac608a1bd9d9a7f658/vite.config.ts#L21-L58).
...
<vp-script setup>
import { Edit, Share, Delete, Search, Loading } from '@vuesax-alpha/icons-vue'
</vp-script>
