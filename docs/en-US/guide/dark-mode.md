...
> If you want an example, you can refer to [vuesax-alpha-vite-starter](https://github.com/vuesax-alphax/vuesax-alpha-vite-starter).
...
@forward 'vuesax-alpha/theme-chalk/src/dark/var.scss' with (
  $bg-color: (
    'page': #0a0a0a,
    '': #626aef,
    'overlay': #1d1e1f,
