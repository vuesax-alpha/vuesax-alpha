...
```html
<script src="//unpkg.com/vuesax-alpha/dist/locale/zh-cn"></script>
<script>
  app.use(ElementPlus, {
...
[Supported Language List](https://github.com/vuesax-alphax/vuesax-alpha/tree/dev/packages/locale/lang)
...
If you need any other languages, [PR](https://github.com/vuesax-alphax/vuesax-alpha/pulls)
is always welcomed, you only need to add a language file at
[here](https://github.com/vuesax-alphax/vuesax-alpha/tree/dev/packages/locale/lang).
