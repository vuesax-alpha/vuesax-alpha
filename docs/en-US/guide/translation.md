...
2. Go to [Element Plus](https://crowdin.com/project/vuesax-alpha) project.
...
You can [raise an issue](https://crowdin.com/project/vuesax-alpha/discussions) on Crowdin to us for
