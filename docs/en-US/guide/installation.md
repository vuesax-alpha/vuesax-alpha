...
[![ElementPlus version badge](https://img.shields.io/npm/v/vuesax-alpha.svg?style=flat-square)](https://www.npmjs.org/package/vuesax-alpha)
...
<head>
  <!-- Import style -->
  <link rel="stylesheet" href="//unpkg.com/vuesax-alpha/dist/index.css" />
  <!-- Import Vue 3 -->
  <script src="//unpkg.com/vue@3"></script>
  <!-- Import component library -->
  <script src="//unpkg.com/vuesax-alpha"></script>
</head>
```
...
<head>
  ...
  <link
    rel="stylesheet"
    href="//cdn.jsdelivr.net/npm/vuesax-alpha/dist/index.css"
  />
  <!-- Import Vue 3 -->
  <script src="//cdn.jsdelivr.net/npm/vue@3"></script>
  <!-- Import component library -->
  <script src="//cdn.jsdelivr.net/npm/vuesax-alpha"></script>
</head>
```
