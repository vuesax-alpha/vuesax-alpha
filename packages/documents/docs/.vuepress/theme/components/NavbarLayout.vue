  ...
  <div id="con-example" class="con-example">
    ...
    <div class="content-1 contentx">
      <div class="con-colors">
        ...
        <vs-radio success v-model="color" val="success"> success </vs-radio>
        <vs-radio danger v-model="color" val="danger"> danger </vs-radio>
        <vs-radio warn v-model="color" val="warn"> warn </vs-radio>
        <vs-radio dark v-model="color" val="dark"> dark </vs-radio>
      </div>
      <div class="con-opts">
