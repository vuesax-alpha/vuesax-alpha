      ...
      <div class="con-desk">
        <div class="code1">
          <pre class="language-html">
            <code>  
              <span class="token comment">&lt;!-- vuesax component --&gt;</span>
              ...
              <vs-col w="7">
                ...
                <div class="con-create-posts-public">
                  <div class="card-post">
                    ...
                    <div class="con-images">
                      <p>
                        Being a <b>#frontend</b> <b>#programmer</b> is the best
                        thing I love the development experience and the whole
                        ecosystem.
                      </p>
                    </div>
                  </div>
                ...
                <div class="con-create-posts-public">
                  <div class="card-post">
                    ...
                    <div class="con-images">
                      <p>
                        I love new Wallpapers minimal 💻😍 <b>#photo</b>
                        <b>#Models</b>
                      </p>
              ...
              <vs-col w="5">
                <div class="con-create-posts-public only-post">
                  <div class="card-post">
                    ...
                    <div class="con-images">
                      <p>New Render 👇 <b>#cinema4d</b> <b>#bender3d</b></p>

                      <div class="content-images">
                        <img
                          src="https://cdn.pixabay.com/photo/2017/01/09/12/08/office-1966384_960_720.jpg"
                          alt=""
                        />
                      </div>
                    </div>
...
.con-create-posts footer .vs-button--icon:hover,
.con-create-posts footer .vs-button--icon:focus {
  opacity: 1;
  filter: grayscale(0%);
}
.code1 {
