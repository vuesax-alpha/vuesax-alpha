...
describe('no injection value', () => {
  ...
  it('usePopperContainerId', () => {
    ...
    expect(wrapper.vm.id).toMatch(/^vs-popper-container-\d{0,4}$/)
    expect(wrapper.vm.selector).toMatch(/^#vs-popper-container-\d{0,4}$/)
...
describe('with injection value', () => {
  ...
  it('usePopperContainerId', () => {
    ...
    expect(wrapper.vm.id).toBe('vs-popper-container-1024')
    expect(wrapper.vm.selector).toBe('#vs-popper-container-1024')
  })
})
