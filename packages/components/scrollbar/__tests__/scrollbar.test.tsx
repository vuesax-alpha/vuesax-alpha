...
import makeScroll from '@vuesax-alpha/test-utils/make-scroll'
import defineGetter from '@vuesax-alpha/test-utils/define-getter'
...
describe('ScrollBar', () => {
  test('vertical', async () => {
    ...
    const scrollDom = wrapper.find('.vs-scrollbar__wrap').element
  ...
  test('should render height props', async () => {
    ...
    expect(wrapper.find('.vs-scrollbar__wrap').attributes('style')).toContain(
      'height: 204px;'
    )
  })
  ...
  test('should render tag props', async () => {
    ...
    expect(
      wrapper.find('.vs-scrollbar__view').element instanceof HTMLUListElement
    ).toBeTruthy()
  })
  ...
  test('should render wrap-class props', async () => {
    ...
    expect(wrapper.find('.vs-scrollbar__wrap').classes()).toContain(wrapClass)
  })
  ...
  test('should render view-style props', async () => {
    ...
    expect(wrapper.find('.vs-scrollbar__view').attributes('style')).toContain(
      viewStyle
    )
  })
  ...
  test('should render view-class props', async () => {
    ...
    expect(wrapper.find('.vs-scrollbar__view').classes()).toContain(viewClass)
  })
})
