...
import type ElTooltip from '@vuesax-alpha/components/tooltip'
import type { QueryChangeCtx, SelectOptionProxy } from '@vuesax-alpha/tokens'
  ...
  useDeprecated(
    {
      ...
      version: '2.3.0',
      scope: 'props',
      ref: 'https://vuesax-alpha.org/en-US/component/select.html#select-attributes',
    },
