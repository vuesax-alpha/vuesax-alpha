...
describe('Rate.vue', () => {
  it('create', () => {
    ...
    const stars = wrapper.findAll('.vs-rate__item')
  ...
  it('size', async () => {
    ...
    expect(wrapper.find('.vs-rate--large').exists()).toBe(true)
    await wrapper.setProps({ size: '' })
    expect(wrapper.find('.vs-rate').exists()).toBe(true)
  })
  ...
  it('allow half', async () => {
    ...
    const secondStar = wrapper.findAll('.vs-rate__item')[1]
  ...
  it('with texts', () => {
    ...
    const text = wrapper.find('.vs-rate__text').element
  ...
  it('click', () => {
    ...
    const thirdStar = wrapper.findAll('.vs-rate__item')[2]
      .element as HTMLElement
    thirdStar.click()
  ...
  it('colors', () => {
    ...
    const rateEl = wrapper.find('.vs-rate').element as HTMLElement
    expect(rateEl.style.getPropertyValue('--vs-rate-fill-color')).toBe(
      '#FF9900'
    )
  })
  ...
  it('change event', () => {
    ...
    const fourthStar = wrapper.findAll('.vs-rate__item')[3]
      .element as HTMLElement
    fourthStar.click()

    expect(value.value).toEqual(4)
    expect(changeCount.value).toEqual(0)
    const fifthStar = wrapper.findAll('.vs-rate__item')[4]
      .element as HTMLElement
    fifthStar.click()
